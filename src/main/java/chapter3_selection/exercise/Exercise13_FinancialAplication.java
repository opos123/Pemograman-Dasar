...
public class Exercise13_FinancialAplication {
    public static void main(String[] args) {
        Scanner input = new Scanner(System.in);

        System.out.println("(0-single filter, 1-married jointly or " +
                "qualifiying widow(er), 2-married separately, 3-head of " +
        ...
        switch (status) {
            ...
            case 2:
                ...
                if (income > 104425)
                    tax += (income <= 186475) ? (income - 104425) * 0.33 : (186425 - 104425) * 0.33;
                if (income > 186474)
                    tax += (income - 33950) * 0.35;
                break;
            case 3:
                tax += (income <= 11950) ? income * 0.10 : 11950 * 0.10;
                if (income > 19950)
                    tax += (income <= 45500) ? (income - 19950) * 0.15 : (45500 - 11950) * 0.15;
                if (income > 45500)
